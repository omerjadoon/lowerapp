@extends('user.seller.layouts.app',['title'=>'Dashboard','request'=>'dashboard'])
@push('css')
@endpush
@section('content')
<div class="container-fluid">
    <div class="page-title">
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="{{route('dashboard.index')}}"><i data-feather="home"></i></a></li>

@extends('user.seller.layouts.app',['title'=>'Account','request'=>'useracc']) @push('css')
<style type="text/css">
    .roundedpencil {
        background: white;
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-options"><a class="card-options-collapse" href="#" data-toggle="card-collapse" data-original-title="" title=""><i class="fe fe-chevron-up"></i></a><a class="card-options-remove" href="#" data-toggle="card-remove" data-original-title=""
                                    ...
                                    <div class="media"><img class="img-70 img-fluid m-r-20 rounded-circle update_img_0" src="{{Auth::user()->sellerDetail->file_path !='' ? asset(Auth::user()->sellerDetail->file_path) : asset('images/avatar.png')}}" alt="" data-original-title="" title="">
                                        ...
                                        <div class="media-body mt-3">
                                            <h5><span class="first_name_0">{{strtoupper(Auth::user()->sellerDetail->title.'
                                               '.Auth::user()->sellerDetail->f_name.' '.Auth::user()->sellerDetail->l_name)}} </span></h5>
